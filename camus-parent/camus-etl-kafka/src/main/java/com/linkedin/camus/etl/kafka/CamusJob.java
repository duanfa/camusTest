...
public class CamusJob extends Configured implements Tool {
	...
	public void runProcess() throws Exception {
		...
		DateTimeFormatter dateFmt = DateUtils.getDateTimeFormatter("YYYY-MM-dd-HH-mm-ss", DateTimeZone.getDefault());
	...
	public static void main(String[] args) throws Exception {
		...
		String[] arg = { "-Pcamus.properties" };
		ToolRunner.run(job, arg);
	}
